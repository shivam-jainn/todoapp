...
const TodoStateCard = () => {
  return (
    <div className=" w-full bottom-5  px-4 shadow-sm shadow-neutral-500 text-sm flex justify-between items-center bg-white p-2 rounded-lg max-sm:justify-center  ">
